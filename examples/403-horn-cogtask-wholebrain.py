...
class HORNSeqLayer(brainstate.nn.Module):
    def __init__(
        ...
        self.h2o = brainstate.nn.Linear(n_hidden, n_out, w_init=out_w_init, b_init=out_b_init)
...
def try1_train_with_biological_connectivity():
...
if __name__ == '__main__':
    try1_train_with_biological_connectivity()

...
# =========================================================================== #
# Less-common Wilson-Cowan variants (migrated from wilson_cowan_variants_test.py)
# =========================================================================== #
# The base ``WilsonCowanStep`` and a few simple variants are tested above; this
# section covers the previously-untested variants -- divisive, divisive-input,
# delayed, adaptive and three-population -- plus the sequence network components
# (``WilsonCowanSeqLayer`` / ``WilsonCowanSeqNetwork``).
...
# Differentiate w.r.t. the excitatory self-coupling ``wEE``. ``strong=True``: the
# Wilson-Cowan gradient is robustly far from zero.
_WC_GRAD_SPEC = dict(
    build=lambda p: brainmass.WilsonCowanStep(_GRAD_IN_SIZE, wEE=Param(p, fit=True)),
...
class TestWilsonCowanGradient:
    """A gradient flows through a short for_loop simulation of WilsonCowanStep."""
